...
function Song(value){
	this.audio = new Audio("../media/" + value);
	this.speed = 5;
...
function Interface(){
	...
	this.Beacon.src = "../img/Beacon-100.png";
	this.draw = function(){
		ctx.fillStyle = "#fff";
	...
	this.updateBeacon = function(value){
		...
		if(value < 75){
			this.Beacon.src = "../img/Beacon-75.png";
		}
		if(value < 50){
			this.Beacon.src = "../img/Beacon-50.png";
		}
		if(value < 25){
			this.Beacon.src = "../img/Beacon-25.png";
		}
		if(value <= 0){
			this.Beacon.src = "../img/Beacon-0.png";
		}
	}
}
function Chat(){
